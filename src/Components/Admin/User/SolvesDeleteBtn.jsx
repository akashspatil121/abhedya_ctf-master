    ...
    return (
      ...
      <Modal show={show} onHide={handleClose} animation={false}>
        <Modal.Header closeButton>
          <Modal.Title>Delete Solves</Modal.Title>
        </Modal.Header>
        <Modal.Body>Are you sure you want to delete 0 Solves?</Modal.Body>
        <Modal.Footer>
...
export default SolvesDeleteBtn;