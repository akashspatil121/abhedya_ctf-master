  ...
  return (
    <div className="crytography_challenges">
      ...
      <div class="mob-content">
        ...
        <p>
          Cryptosystem is the associated items of cryptography that are used as
          a unit to provide a single means of encryption and decryption.
        </p>
        <p>
          The Enigma machine is a cipher device developed and used in the early-
          to mid-20th century to protect commercial, diplomatic, and military
          communication.
        </p>
      </div>
      ...
      <div class="mobtab">
        ...
        <div class="mobtab-container">
          <div class="mobtab-content">
            ...
            <p>
              <b>Facts:</b>
              <br /> Cryptosystem is the associated items of cryptography that
              are used as a unit to provide a single means of encryption and
              decryption.
            </p>
            <p>
