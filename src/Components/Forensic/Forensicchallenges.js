      ...
      <div class="mobtab">
        ...
        <div class="mobtab-container">
          <div class="mobtab-content">
            ...
            <p>
              <b>Facts:</b>
              <br /> Deleted computer files can be recovered even after a hard drive is reformatted or repartitioned
            </p>
          </div>
        </div>
      </div>
...
export default Forensicchallenges;
