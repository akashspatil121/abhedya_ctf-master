  ...
  return (
    <div className="crytography_challenges">
      ...
      <div class="mob-content">
        ...
        <p><b>Facts</b><br/>Hackers use OSINT to identify technical vulnerabilities as well as human targets for phishing and social engineering attacks</p>
      </div>
      ...
      <div class="mobtab">
        ...
        <div class="mobtab-container">
          <div class="mobtab-content">
            <p class="mobtab-heading">Osint</p>
            ...
            <p>
              <b>Facts</b>
              <br />
              Hackers use OSINT to identify technical vulnerabilities as well as
              human targets for phishing and social engineering attacks
            </p>
          </div>
        </div>
      </div>
